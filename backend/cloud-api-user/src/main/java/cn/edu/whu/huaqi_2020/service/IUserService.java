...
public interface IUserService {
    ...
    default List<Map<String, Object>> selectByExample(String var) {
        return new LinkedList<>();
    }

    default Map<String, Object> updateByPrimaryKeySelective(User user) {
        return new HashMap<>();
    }

    default Map<String, Object> updateByPrimaryKey(UserDO record) {
        return new HashMap<>();
    }
}
